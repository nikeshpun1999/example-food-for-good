...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecipeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecipeViewHolder recipeViewHolder, int i) {
        ...
        Picasso.with(context).load(BASE_URL+"/images/"+recipeModel.getRecipeImgName()).into(recipeViewHolder.img);
        Log.d("log", "onBindViewHolder: "+BASE_URL+"/images/"+recipeModel.getRecipeName());
        ...
        recipeViewHolder.img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String send_path=BASE_URL+"images/"+recipeModel.getRecipeImgName();
                ...
                intent.putExtra("recipeimageName",BASE_URL+"/images/"+recipeModel.getRecipeImgName());
